...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08/07/2023 às 23:44
...
--
-- Banco de dados: `bd_delivery`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `bairros_delivery`
--
...
--
-- Despejando dados para a tabela `bairros_delivery`
--
...
(1, 'Cardapion', 'Delivery online via WhatsApp.', 'Crie um cardápio online atraente que inspire o apetite.', 'pizza, delivery food, fast food, sushi, take away, chinese, italian food', '31980209666', '31980209666', 'contato@cardapion.tk', '09:00hs ás 18:00hs', 'https://www.youtube.com/', 'facebook', 'instagram', 'youtube', 'PLANO MENSAL', 50, 30, 'PLANO TRIMESTRAL', 160, 90, 'PLANO ANUAL', 390, 365, 5, 'APP_USR-d6d696f6-2db2-4693-a6c0-08ce23636da1', 'APP_USR-1625076714913746-053018-f8a18770f28fbcfc221029a2b530711a-281362235');
...
--
-- Despejando dados para a tabela `cupom_desconto`
--
...
--
-- Despejando dados para a tabela `views`
--
...
--
-- Estrutura para tabela `ws_adicionais_itens`
--
...
--
-- Despejando dados para a tabela `ws_adicionais_itens`
--
...
--
-- Estrutura para tabela `ws_admin`
--
...
--
-- Despejando dados para a tabela `ws_admin`
--
...
--
-- Despejando dados para a tabela `ws_cat`
--
...
--
-- Estrutura para tabela `ws_datas_close`
--
...
--
-- Despejando dados para a tabela `ws_datas_close`
--
...
--
-- Estrutura para tabela `ws_empresa`
--
...
--
-- Despejando dados para a tabela `ws_empresa`
--
...
(21, 1, 'DEMONSTRAÇÃO', 'Desde 2020 entregando os lanches mais sinistros da cidade!', 'Demo', '', 'admin@cardapion.tk', '31980209666', 'Rua Silvio Barbini', 'Itaquera', 'Itaporanga d´Ajuda', 'SE', '08200-030', 'images/2020/05/img-teste.png', 'images/2020/07/unnamed.png', 2, 2, 2, 'https://www.facebook.com/', 'https://www.instagram.com/', 'https://www.facebook.com/', '', 'true', 'true', 'true', 'true', 'true', 'true', 'false', 'true', 'true', 'true', 'true', 'true', 'true', 'true', '00:00', '12:00', '17:00', '00:00', '00:00', '00:00', '00:00', '00:00', '06:00', '14:00', '17:00', '00:00', '06:00', '12:00', '14:00', '00:00', '06:00', '14:00', '17:00', '00:00', '00:00', '14:00', '00:00', '00:00', '00:00', '00:00', '17:00', '23:59', '6.00', '50.00', 1, '2029-05-16', 'Entre 30 e 60 minutos.', 'Em 30 minutos.', '15.00', 'true', 'true', 'true');

-- --------------------------------------------------------

--
-- Estrutura para tabela `ws_formas_pagamento`
--
...
--
-- Despejando dados para a tabela `ws_formas_pagamento`
--
...
--
-- Estrutura para tabela `ws_impressora`
--
...
--
-- Despejando dados para a tabela `ws_impressora`
--
...
--
-- Estrutura para tabela `ws_itens`
--
...
--
-- Despejando dados para a tabela `ws_itens`
--
...
(104, 1, 46, 'images/2020/05/download-1585609494.jpg', 'Coca Cola', 'Lata 350ml', '4.00', 0, 1, 'Domingo,Segunda,Terça,Quarta,Quinta,Sexta,Sabado', 0),
...
--
-- Estrutura para tabela `ws_opcoes_itens`
--
...
--
-- Despejando dados para a tabela `ws_opcoes_itens`
--
...
--
-- Estrutura para tabela `ws_pedidos`
--
...
(17, 1, 'PED1020-2', '2020-10-01 15:53:24', '2020-10', '2020-10-01', '<b>Qtd:</b> 3x AVEXADO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 45,00<br /><b>OBS:</b> Não<br /><br />', 'Cartão Debito', '0.00', 'true', '6.00', '79991322619', '0', '45.00', '51.00', 'Alex', '79991322619', 'rua 3', 32, 'Santos Dumont', 'Arapiraca', 'AL', '', '*Não informado*', '*Não informado*', '', 'Em Andamento', '10', '20', 1, 0, 'false', ''),
(18, 1, 'PED0723-1', '2023-07-07 23:51:20', '2023-07', '2023-07-07', '<b>Qtd:</b> 1x Ô CABRUNCO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 8,00<br /><b>OBS:</b> Não<br /><br />', '', '0.00', 'false', '0.00', '31980209666', '0', '8.00', '8.00', 'Nathan', '79999999999', '', 0, '', '', '', '', '*Não informado*', '*Não informado*', 'Nenhuma', 'Em Andamento', '07', '23', 1, 0, 'false', 'Mesa: 2<br />Pessoas: 1'),
(19, 1, 'PED0723-2', '2023-07-08 00:08:21', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x Ô CABRUNCO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 8,00<br /><b>OBS:</b> Não<br /><br />', 'Dinheiro', '0.00', 'false', '0.00', '31980209666', '0', '8.00', '8.00', 'Nathan', '79999999999', '', 0, '', '', '', '', '*Não informado*', '*Não informado*', 'Nenhuma', 'Finalizado', '07', '23', 1, 0, 'false', 'Mesa: 5<br />Pessoas: 1'),
(20, 1, 'PED0723-3', '2023-07-08 16:40:48', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x Ô CABRUNCO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 8,00<br /><b>OBS:</b> Não<br /><br />', 'Dinheiro', '0.00', 'false', '0.00', '31980209666', '0', '8.00', '8.00', 'Nathan', '79999999999', '', 0, '', '', '', '', '*Não informado*', '*Não informado*', '', 'Aberto', '07', '23', 0, 0, 'true', 'Retirada no Balcão'),
(21, 1, 'PED0723-4', '2023-07-08 16:47:44', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x EXIBIDO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 18,00<br /><b>OBS:</b> Não<br /><br />', 'Dinheiro', '0.00', 'true', '6.00', '31980209666', '0', '18.00', '24.00', 'Stefane%20Rosa%20Souza', '79999999999', 'Rua José Augustos dos Santos, Número 29', 29, 'Santos Dumont', 'Arapiraca', 'AL', '49031020', '49031020', '*Não informado*', '', 'Aberto', '07', '23', 0, 0, 'false', ''),
(22, 1, 'PED0723-5', '2023-07-08 16:53:49', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x AVEXADO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 15,00<br /><b>OBS:</b> Não<br /><br />', 'Dinheiro', '0.00', 'true', '4.50', '31980209666', '0', '15.00', '19.50', 'Stefane%20Rosa%20Souza', '79999999999', 'Rua José Augustos dos Santos, Número 29', 29, 'Siqueira Campos', 'Aracaju', 'SE', '49031020', '*Não informado*', '*Não informado*', '', 'Aberto', '07', '23', 0, 0, 'false', ''),
(23, 1, 'PED0723-6', '2023-07-08 16:54:05', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x AVEXADO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 15,00<br /><b>OBS:</b> Não<br /><br />', '', '0.00', 'false', '0.00', '31980209666', '0', '15.00', '15.00', 'Stefane%20Rosa%20Souza', '79999999999', '', 0, '', '', '', '', '*Não informado*', '*Não informado*', 'Nenhuma', 'Aberto', '07', '23', 0, 0, 'false', 'Mesa: 1<br />Pessoas: 1'),
(24, 1, 'PED0723-7', '2023-07-08 16:54:22', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x CAMPEÃO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 6,00<br /><b>OBS:</b> Não<br /><br />', '', '0.00', 'false', '0.00', '31980209666', '0', '6.00', '6.00', 'Stefane%20Rosa%20Souza', '79999999999', '', 0, '', '', '', '', '*Não informado*', '*Não informado*', 'Nenhuma', 'Aberto', '07', '23', 0, 0, 'false', 'Mesa: 1<br />Pessoas: 1'),
(25, 1, 'PED0723-8', '2023-07-08 16:54:52', '2023-07', '2023-07-08', '<b>Qtd:</b> 1x EXIBIDO<br /><b>Adicionais:</b> Sem Adicionais<br /><b>Valor:</b> R$ 18,00<br /><b>OBS:</b> Não<br /><br />', 'Dinheiro', '0.00', 'false', '0.00', '31980209666', '0', '18.00', '18.00', 'Stefane%20Rosa%20Souza', '79999999999', '', 0, '', '', '', '', '*Não informado*', '*Não informado*', '', 'Em Andamento', '07', '23', 1, 0, 'false', 'Retirada no Balcão');

-- --------------------------------------------------------

--
-- Estrutura para tabela `ws_pedidos_itens`
--
...
--
-- Despejando dados para a tabela `ws_pedidos_itens`
--
...
(23, 18, 1, 'PED0723-1', 96, 1, '8.00', '', 'Não'),
(24, 19, 1, 'PED0723-2', 96, 1, '8.00', '', 'Não'),
(25, 20, 1, 'PED0723-3', 96, 1, '8.00', '', 'Não'),
(26, 21, 1, 'PED0723-4', 99, 1, '18.00', '', 'Não'),
(27, 22, 1, 'PED0723-5', 98, 1, '15.00', '', 'Não'),
(28, 23, 1, 'PED0723-6', 98, 1, '15.00', '', 'Não'),
(29, 24, 1, 'PED0723-7', 100, 1, '6.00', '', 'Não'),
(30, 25, 1, 'PED0723-8', 99, 1, '18.00', '', 'Não');

-- --------------------------------------------------------

--
-- Estrutura para tabela `ws_relacao_tamanho`
--
...
--
-- Despejando dados para a tabela `ws_relacao_tamanho`
--
...
--
-- Estrutura para tabela `ws_tipo_produto`
--
...
--
-- Despejando dados para a tabela `ws_tipo_produto`
--
...
(1, 'Renato', 'Patrick', 'admin@cardapion.tk', '', '(31).8020.9666', 'images/2018/07/cd-img-3.png', '25d55ad283aa400af464c76d713c07ad', '2014-02-11 13:14:04', ' Último acesso em: 14/10/2020 11:52 IP: 187.0.47.6 ', 3, 1, '', 0, '', 0, '', '', '0000-00-00');
...
--
-- Índices de tabela `bairros_delivery`
--
...
--
-- Índices de tabela `cupom_desconto`
--
...
--
ALTER TABLE `ws_pedidos_itens`
  MODIFY `ID_TABELA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
